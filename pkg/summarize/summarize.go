...
// NewClient creates a new OllamaClient using the http.DefaultClient
func NewClient(address, model string) *OllamaClient {
	oc := OllamaClient{
		Address:    address,
		Model:      model,
...
// ChatRequest HTTP body to send for the Summarize method.
...
// ChatResponse HTTP body returned by Ollama
...
// PullRequest HTTP body to send for the UpdateModel method.
